...
public class Program79 extends Canvas
{
	public void paint( Graphics g )
	{
		...
		g.setFont(new Font("Monaco", Font.BOLD+Font.ITALIC, 60)); // 60-pt italic bold
		g.drawString("Leander Lions", 300, 350);

		g.setColor(Color.blue);
		g.setFont(Font.decode("Monaco-BOLDITALIC-60")); // a different way to specify the same font
	...
	{
		JFrame win = new JFrame("Program79: Fonts and Lines");
		win.setSize(800,600);
		win.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		Program79 canvas = new Program79();
		win.add( canvas );
		win.setVisible(true);
	}
}
